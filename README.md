...
I am a **Computer Science Technology** student at **LaSalle College** in Montreal. My focus is on building high-performance, user-centric mobile applications. My journey into tech is driven by a love for logical puzzles and a background in high-pressure, precision-focused environments.
...
| :--- | :--- |
| **Mobile Development** | Swift (iOS), Java (Android), SwiftUI, UIKit, XML |
| **Back-end & Web** | C# (ASP.NET), Python, SQL |
| **Tools & Environment** | Git/GitHub, Xcode, Android Studio, VS Code |
| **Soft Skills** | Agile Collaboration, Problem Solving, Leadership, Bilingual (FR/EN) |
...
* **Reliability:** 4 years of consistent, high-standard execution.

I also spent 4+ years as a **Master Corporal** in the Army Cadets, where I learned that effective leadership starts with clear communication and adaptability.
